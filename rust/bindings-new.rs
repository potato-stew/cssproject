...
assert_eq ! (:: std :: mem :: size_of :: < hash > ( ) , 32usize , concat ! ( "Size of: " , stringify ! ( hash ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL18s_p_saved_filename"] pub static mut s_p_saved_filename : * const :: std :: os :: raw :: c_char ;
...
assert_eq ! (:: std :: mem :: size_of :: < parseconf_bool_setting > ( ) , 16usize , concat ! ( "Size of: " , stringify ! ( parseconf_bool_setting ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL20parseconf_bool_array"] pub static mut parseconf_bool_array : [parseconf_bool_setting ; 81usize] ;
...
assert_eq ! (:: std :: mem :: size_of :: < parseconf_uint_setting > ( ) , 16usize , concat ! ( "Size of: " , stringify ! ( parseconf_uint_setting ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL20parseconf_uint_array"] pub static mut parseconf_uint_array : [parseconf_uint_setting ; 21usize] ;
...
assert_eq ! (:: std :: mem :: size_of :: < parseconf_str_setting > ( ) , 16usize , concat ! ( "Size of: " , stringify ! ( parseconf_str_setting ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL19parseconf_str_array"] pub static mut parseconf_str_array : [parseconf_str_setting ; 33usize] ;
...
assert_eq ! (:: std :: mem :: size_of :: < sock_fprog > ( ) , 16usize , concat ! ( "Size of: " , stringify ! ( sock_fprog ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL15s_syscall_index"] pub static mut s_syscall_index : usize ;

}
 extern "C" {
# [link_name = "\u{1}_ZL19s_1_arg_validations"] pub static mut s_1_arg_validations : usize ;

}
 extern "C" {
# [link_name = "\u{1}_ZL19s_2_arg_validations"] pub static mut s_2_arg_validations : usize ;

}
 extern "C" {
# [link_name = "\u{1}_ZL19s_3_arg_validations"] pub static mut s_3_arg_validations : usize ;

}
 extern "C" {
# [link_name = "\u{1}_ZL10s_syscalls"] pub static mut s_syscalls : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_errnos"] pub static mut s_errnos : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_args_1"] pub static mut s_args_1 : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_vals_1"] pub static mut s_vals_1 : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_args_2"] pub static mut s_args_2 : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_vals_2"] pub static mut s_vals_2 : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_args_3"] pub static mut s_args_3 : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL8s_vals_3"] pub static mut s_vals_3 : [:: std :: os :: raw :: c_int ; 100usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL10s_children"] pub static mut s_children : :: std :: os :: raw :: c_uint ;

}
 extern "C" {
# [link_name = "\u{1}_ZL17s_p_ip_count_hash"] pub static mut s_p_ip_count_hash : * mut hash ;

}
 extern "C" {
# [link_name = "\u{1}_ZL15s_p_pid_ip_hash"] pub static mut s_p_pid_ip_hash : * mut hash ;

}
 extern "C" {
# [link_name = "\u{1}_ZL13s_ipaddr_size"] pub static mut s_ipaddr_size : :: std :: os :: raw :: c_uint ;
...
assert_eq ! (:: std :: mem :: size_of :: < mystr_list_node > ( ) , 32usize , concat ! ( "Size of: " , stringify ! ( mystr_list_node ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL10s_null_str"] pub static mut s_null_str : mystr ;
...
pub fn psiginfo (__pinfo : * const siginfo_t , __s : * const :: std :: os :: raw :: c_char) ;
 ...
 extern "C" {
# [link_name = "\u{1}__xpg_sigpause"] pub fn sigpause (__sig : :: std :: os :: raw :: c_int) -> :: std :: os :: raw :: c_int ;
...
pub fn sendfile64 (__out_fd : :: std :: os :: raw :: c_int , __in_fd : :: std :: os :: raw :: c_int , __offset : * mut __off64_t , __count : usize) -> isize ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL13s_p_proctitle"] pub static mut s_p_proctitle : * mut :: std :: os :: raw :: c_char ;
...
pub fn versionsort64 (__e1 : * mut * const dirent64 , __e2 : * mut * const dirent64) -> :: std :: os :: raw :: c_int ;
 ...
 # [repr ( C )] # [derive ( Debug , Copy , Clone )] pub struct timex {
...
assert_eq ! (:: std :: mem :: size_of :: < timex > ( ) , 208usize , concat ! ( "Size of: " , stringify ! ( timex ) )) ;
 ...
 impl timex {
# [inline] pub fn new_bitfield_1 () -> __BindgenBitfieldUnit < [u8 ; 44usize] , u8 > {
...
pub fn setpriority (__which : __priority_which_t , __who : id_t , __prio : :: std :: os :: raw :: c_int) -> :: std :: os :: raw :: c_int ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL15s_current_umask"] pub static mut s_current_umask : :: std :: os :: raw :: c_uint ;

}
 extern "C" {
# [link_name = "\u{1}_ZL14s_current_time"] pub static mut s_current_time : timeval ;

}
 pub const s_current_pid : :: std :: os :: raw :: c_int = - 1 ;
 extern "C" {
# [link_name = "\u{1}_ZL11s_exit_func"] pub static mut s_exit_func : exitfunc_t ;

}
 extern "C" {
# [link_name = "\u{1}_ZL10s_timezone"] pub static mut s_timezone : :: std :: os :: raw :: c_long ;

}
 # [repr ( C )] # [derive ( Debug , Copy , Clone )] pub struct vsf_sysutil_sig_details {
pub sync_sig_handler : vsf_sighandle_t , pub p_private : * mut :: std :: os :: raw :: c_void , pub pending : sig_atomic_t , pub running : :: std :: os :: raw :: c_int , pub use_alarm : :: std :: os :: raw :: c_int ,
}
...
assert_eq ! (:: std :: mem :: size_of :: < vsf_sysutil_sig_details > ( ) , 32usize , concat ! ( "Size of: " , stringify ! ( vsf_sysutil_sig_details ) )) ;
 ...
 extern "C" {
# [link_name = "\u{1}_ZL13s_sig_details"] pub static mut s_sig_details : [vsf_sysutil_sig_details ; 65usize] ;

}
 extern "C" {
# [link_name = "\u{1}_ZL12s_io_handler"] pub static mut s_io_handler : vsf_context_io_t ;

}
 extern "C" {
# [link_name = "\u{1}_ZL22s_p_io_handler_private"] pub static mut s_p_io_handler_private : * mut :: std :: os :: raw :: c_void ;

}
 extern "C" {
# [link_name = "\u{1}_ZL20s_io_handler_running"] pub static mut s_io_handler_running : :: std :: os :: raw :: c_int ;
